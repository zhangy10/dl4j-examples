...
//        if (zacStep.getAction() == MAX_STEP - 1) {
//            System.out.println("[The round done]: " + zacStep.getAction());
//            testPlay(fetchable);
//            return true;
//        }
//        return false;
...
//            rewardList.add(String.format("[-----------<step: %d, %s>------------]", zacStep.getAction(), zacReply.toString()));
//        }
        return true;
...
//
//
//        if (zacStep.getAction() > ACTION_SIZE) {
//            int gap = zacStep.getAction() - ACTION_SIZE;
//            reward -= gap;
//        }
