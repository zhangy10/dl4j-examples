...
public class ZacQLearning <O extends Encodable> extends QLearning<O, Integer, DiscreteSpace> {
    ...
    public ZacQLearning(MDP<O, Integer, DiscreteSpace> mdp, IDQN dqn, QLConfiguration conf,
        ...
        // TODO
        egPolicy = new ZacGreedy(policy, mdp, conf.getUpdateStart(), epsilonNbStep, getRandom(), conf.getMinEpsilon(),
            this);
    ...
    @Override
    protected EpsGreedy<O, Integer, DiscreteSpace> getEgPolicy() {
        return egPolicy;
    }
