...
//            DataUtilities.extractTarGz(localFilePath, basePath);
        ...
        File trainData = new File("/Users/zhangyu/Downloads/10png/train");
        FileSplit trainSplit = new FileSplit(trainData, NativeImageLoader.ALLOWED_FORMATS, randNumGen);
        ParentPathLabelGenerator labelMaker = new ParentPathLabelGenerator(); // parent path as the image label

        // Test: vectorization of test data
        File testData = new File("/Users/zhangyu/Downloads/10png/test");
...
//                   .weightInit(WeightInit.XAVIER)
                   ...
                   .l2(5 * 1e-4)
                   .list()
                   .layer(0, convNet("c1", channels, 20, new int[]{kernel, kernel}, new int[]{1, 1}, new int[]{0, 0}, 0))
                   .layer(1, maxpooling("m1", new int[]{2, 2}, new int[]{2, 2}))
                   .layer(2, convNet("c2", -1, 50, new int[]{kernel, kernel}, new int[]{1, 1}, new int[]{0, 0}, 0))
...
//                                           .biasUpdater(new Nesterovs(new StepSchedule(ScheduleType.ITERATION, 2e-2, 0.1, 100000), 0.9))
                   ...
                   .layer(0, convNet("c1", channels, 25, new int[]{5, 5}, new int[]{1, 1}, new int[]{0, 0}, 0))
                   .layer(1, new LocalResponseNormalization.Builder().name("lrn1").build())
                   .layer(2, maxpooling("m1", new int[]{2, 2}, new int[]{2, 2}))
                   .layer(3, convNet("c2", -1, 55, new int[]{5, 5}, new int[]{1, 1}, new int[]{0, 0}, nonZeroBias))
                   .layer(4, new LocalResponseNormalization.Builder().name("lrn2").build())
                   .layer(5, maxpooling("m2", new int[]{2, 2}, new int[]{2, 2}))
                   .layer(6, convNet("c3", -1, 85, new int[]{3, 3}, new int[]{1, 1}, new int[]{0, 0}, 0))
                   .layer(7, convNet("c4", -1, 85, new int[]{3, 3}, new int[]{1, 1}, new int[]{0, 0}, nonZeroBias))
                   .layer(8, convNet("c5", -1, 55, new int[]{3, 3}, new int[]{1, 1}, new int[]{0, 0}, nonZeroBias))
