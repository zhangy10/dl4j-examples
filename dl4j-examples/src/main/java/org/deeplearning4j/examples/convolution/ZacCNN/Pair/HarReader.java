...
public class HarReader extends CSVRecordReader {
    ...
    public HarReader(int skipnum, int height, int width, int channels, int labelNum, int taskNum, char delimiter, boolean is1D) {
        this(skipnum, height, width, channels, labelNum, taskNum, delimiter);
        this.is1D = is1D;
    }
